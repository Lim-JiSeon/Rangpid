    ...
    return (
        ...
        <div className='container'>
            <div id='container-contents'>
                <div className='sub-title'>정보 수정</div>
                <div className='info-input-container'>
                    ...
                    <div className='link-input-container'>
                        ...
                        <input className='link-input'
                            placeholder={props.user['link']}
                            value={props.user['link']}></input>
                    ...
                    <div className='keyword-content-container'>
                        <div className='mini-title'>키</div>
                            <input className='height-input'
                                placeholder={props.user['height']}
                                value={props.user['height']}></input>
